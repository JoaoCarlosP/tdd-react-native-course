...
describe('WeatherService', () => {
  ...
  test('Should return formatted currentWrather from API', async () => {
  ...
  test('Should return formated currentWeather with empty weather', async () => {
    ...
    nock('https://api.openweathermap.org').get('/data/2.5/weather').query(true).reply(200, mockResponseEmptyWeather)

...
export function fetchWeather (latitude: number, longitude: number): WEATHER_START_TYPE {
  return {
    type: Actions.START,
...
export function fetchWeatherSuccess (weather: WeatherType): WEATHER_SUCCESS_TYPE {
  return {
    type: Actions.SUCCESS,
    payload: { weather }
  }
...
export type ActionsTypes = WEATHER_START_TYPE | WEATHER_FAILURE_TYPE | WEATHER_RESET_TYPE | WEATHER_SUCCESS_TYPE
